...
namespace ITCenterBack.Controllers
{
	...
	public class SquareController : Controller
	{
		...
		[HttpGet]
		[Route("it-courses")]
		[ActionName("it-courses")]
		public async Task<IActionResult> ITCourses()
		{
            var sections = await _sectionService.GetAllSections();
            var sectionsVM = _mapper.Map<List<SectionViewModel>>(sections);
		...
		[Route("STEM")]
		[ActionName("STEM")]
		public async Task<IActionResult> STEM()
		{
            var sections = await _sectionService.GetAllSections();
            var sectionsVM = _mapper.Map<List<SectionViewModel>>(sections);
		...
		[HttpGet]
		[Route("CourseStudents")]
		[ActionName("CourseStudents")]
		...
		[HttpGet]
		[Route("FutureOrientation")]
		[ActionName("FutureOrientation")]
		public async Task<IActionResult> FutureOrientation()
		{
            var sections = await _sectionService.GetAllSections();
            var sectionsVM = _mapper.Map<List<SectionViewModel>>(sections);
