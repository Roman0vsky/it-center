...
$(document).ready(function() {
    ...
    $("#waituk-owl-slide-1").owlCarousel({
        ...
        autoplayTimeout:3000,
        nav: true,
        navText: ['<span class="icon-angle-left tundra"></span>', '<span class="icon-angle-right tundra"></span>'],
        dots: true,
        responsive: {
            767: {
                items: 3,
    ...
    $("#waituk-owl-slide-6").owlCarousel({
        loop: true,
        margin: 30,
        responsiveClass: true,
        items: 1,
        ...
        autoplayTimeout:3000,
        nav: true,
        navText: ['<span class="icon-angle-left text-white"></span>', '<span class="icon-angle-right text-white"></span>'],
        dots: true,
        responsive: {
            767: {
                items: 3,
    ...
    $("#waituk-owl-slide-7").owlCarousel({
        loop: true,
        margin: 30,
        responsiveClass: true,
        items: 1,
    ...
    $("#waituk-owl-slide-8").owlCarousel({
        loop: true,
        margin: 30,
        responsiveClass: true,
        items: 1,
    ...
    $win.load(function() {
        ...
        var $location = $(window.location.toString().slice(window.location.toString().indexOf('?')).split(/[&?]{1}[\w\d]+=/));
        var filterValue = $location[1];
